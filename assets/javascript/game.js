$(document).ready(function () {
	...
	function reset() {		
		...
		required = Math.floor(Math.random() * 102) + 19;
		$("#required").html(required);

		score = 0;
		$("#player").html(score);

		potion1 = Math.floor(Math.random() * 12) + 1;
		$("#obj1").attr("value", potion1);
		console.log(potion1);

		potion2 = Math.floor(Math.random() * 12) + 1;
		$("#obj2").attr("value", potion2);
		console.log(potion2);

		potion3 = Math.floor(Math.random() * 12) + 1;
		$("#obj3").attr("value", potion3);
		console.log(potion3);

		potion4 = Math.floor(Math.random() * 12) + 1;
		$("#obj4").attr("value", potion4);
		console.log(potion4);
